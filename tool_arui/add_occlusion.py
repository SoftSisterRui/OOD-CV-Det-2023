...
"""
anno_dir = '/root/mmdetection-main/data/OOD-CV-det-2023/train/Annotations/'
image_dir = '/root/mmdetection-main/data/OOD-CV-det-2023/train/Images/'
mask_image_dir = '/root/mmdetection-main/data/OOD-CV-det-2023/train/add_occlusion_image/'
mask_xml_dir = '/root/mmdetection-main/data/OOD-CV-det-2023/train/add_occlusion_anno/'
occlusion_dir = '/root/mmdetection-main/data/OOD-CV-det-2023/be_occlusion/'
Ratio = [1 / 4, 1 / 2, 3 / 4]
IsImage = True
IsFilling = True
